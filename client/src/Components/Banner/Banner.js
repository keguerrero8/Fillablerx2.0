...
function Banner() {
    ...
    const announcementTertiary = "Shortage Announcement: 7/19 Oxycoodne-Acetaminophen Tablets, 7/20 Liraglutide Injection, 7/31 Methylphenidate IR Tablets, 8/2 Decitabine Injection, 8/7 Alfuzosin Tablets";
